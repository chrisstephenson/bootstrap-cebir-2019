...
(define oyuncu-genişliği (image-width oyuncu))
(define oyuncu-yüksekliği (image-height oyuncu))
...
(ÖRNEK (c-içinde-üst? 30) (< 30 (- arkaplan-yüksekliği (/ oyuncu-yüksekliği 2))))
...
(define (evren-çiz e) (place-text/v (v 200 50) "SKOR: " 60 "red"(nesne-çiz (evren-n1 e) (nesne-çiz (evren-n2 e) (nesne-çiz (evren-n3 e) (nesne-çiz (evren-n4 e)  (evren-bg e)))))))
