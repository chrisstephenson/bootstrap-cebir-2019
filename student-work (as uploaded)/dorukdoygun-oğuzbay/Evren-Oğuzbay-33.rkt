...
(define düşman1 (nesne (scale 0.8 (bitmap "imaj/duşmanbüyükson.png")) (v 1300 (* (random 1 4) 150) ) (v -3 0) (v -0.02 0)))
(define düşman2 (nesne (scale 0.05 (bitmap "imaj/düşmanküçükson.png")) (v 1300 (* (random 1 4) 150 )) (v -3 0) (v -0.02 0)))
(define düşman3 (nesne (scale 0.05 (bitmap "imaj/düşmanküçükson2.png")) (v 1300 (* (random 1 4) 150 )) (v -3 0) (v -0.02 0)))
...
(define (evren-çiz e)
  (place-text/v (v 200 50)  (string-append "SKOR:" (number->string (evren-skor e))) 35 "red"
...
;;;;;;;;;;;;;;;;;;;;;;;;;;
 ( (<  (mesafe (nesne-yer (evren-n5 e)) (nesne-yer (evren-n2 e)))
        (+  (image-width (nesne-imaj(evren-n5 e))) (/ (image-width (nesne-imaj(evren-n2 e)))2)))
