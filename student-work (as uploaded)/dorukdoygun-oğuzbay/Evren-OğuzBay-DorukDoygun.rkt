...
(define düşman1 (nesne (scale 0.8 (bitmap "imaj/duşmanbüyükson.png")) (v 1300 (* (random 1 4) 150) ) (v -3 0) (v -0.025 0)))
(define düşman2 (nesne (scale 0.05 (bitmap "imaj/düşmanküçükson.png")) (v 1300 (* (random 1 4) 150 )) (v -3 0) (v -0.025 0)))
(define düşman3 (nesne (scale 0.05 (bitmap "imaj/düşmanküçükson2.png")) (v 1300 (* (random 1 4) 150 )) (v -3 0) (v -0.025 0)))
(define ateş (nesne (rectangle 20 4 "solid" "red") (v 40 600)  (v 80 0) (v 0 0)))
(define welldone (bitmap "imaj/well done.png"))
(define gameover (bitmap "imaj/gameover.jpg"))
...
(STRUCT evren (bg n1 n2 n3 n4 n5 skor))
...
(ÖRNEK
 ...
 (place-text/v (v 200 50) (string-append "SKOR:" (number->string 0))  35 "red"
               (nesne-çiz  oyuncu
...
(define (evren-çiz e)
  (place-text/v (v 500 50)  (string-append "SKOR:" (number->string (evren-skor e))) 35 "royalblue"
                (place-text/v (v 200 50) "ProjectSpace"    25 "royalblue"
                (nesne-çiz (evren-n1 e) (nesne-çiz (evren-n2 e) (nesne-çiz (evren-n3 e) (nesne-çiz (evren-n4 e) (nesne-çiz (evren-n5 e) (evren-bg e)))))))))
...
(define arkadış
  (+ (image-width (evren-bg yaradılış)) (/ (image-width (nesne-imaj (evren-n2 yaradılış))) 2)))
...
;mesafe
(define (mesafe v1 v2)
(sqrt (+(sqr (- (v-x v1) (v-x v2)))
  (sqr (- (v-y v1) (v-y v2))))))


(define (çarpışma e)
  (cond
   ( (<  (mesafe (nesne-yer (evren-n1 e)) (nesne-yer (evren-n2 e)))
        (+ (/ (image-width (nesne-imaj(evren-n1 e)))2) (/ (image-width (nesne-imaj(evren-n2 e)))2)))
    (evren
   (evren-bg e)
   (evren-n1 e)
   (nesne (nesne-imaj (evren-n2 e))(v arkadış (* (random 1 4) 150) ) (nesne-hız (evren-n2 e)) (nesne-ivme (evren-n2 e)))
   (evren-n3 e)
   (evren-n4 e)
   (evren-n5 e) 
   (- (evren-skor e) 20 )))
    ( (<  (mesafe (nesne-yer (evren-n1 e)) (nesne-yer (evren-n3 e)))
        (+ (/ (image-width (nesne-imaj(evren-n1 e)))2) (/ (image-width (nesne-imaj(evren-n3 e)))2)))
   ...
   (evren-n2 e)
   (nesne (nesne-imaj
           (evren-n3 e)) (v arkadış (* (random 1 4) 150 )) (nesne-hız (evren-n3 e)) (nesne-ivme (evren-n3 e)))
   (evren-n4 e)
   (evren-n5 e) 
   (- (evren-skor e) 20 )))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ( (<  (mesafe (nesne-yer (evren-n1 e)) (nesne-yer (evren-n4 e)))
        (+ (/ (image-width (nesne-imaj(evren-n1 e)))2) (/ (image-width (nesne-imaj(evren-n4 e)))2)))
      (evren
   (evren-bg e)
   (evren-n1 e)
   (evren-n2 e)
   (evren-n3 e)
   (nesne (nesne-imaj
           (evren-n4 e)) (v arkadış (* (random 1 4) 150 )) (nesne-hız (evren-n4 e)) (nesne-ivme (evren-n4 e)))
   
   (evren-n5 e) 
   (- (evren-skor e) 20 )))
;;;;;;;;;;;;;;;;;;;;;;;;;;
 ( (<  (mesafe (nesne-yer (evren-n5 e)) (nesne-yer (evren-n2 e)))
        (+  (image-width (nesne-imaj(evren-n5 e)))  (image-width (nesne-imaj(evren-n2 e)))))
   ...
   (evren-n1 e)
   (nesne (nesne-imaj
           (evren-n2 e)) (v arkadış (* (random 1 4) 150 )) (nesne-hız (evren-n2 e)) (nesne-ivme (evren-n2 e)))
   (evren-n3 e)
   (evren-n4 e)
   (evren-n5 e) 
   (+ (evren-skor e) 20 )))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
 ( (<  (mesafe (nesne-yer (evren-n5 e)) (nesne-yer (evren-n3 e)))
        (+  (image-width (nesne-imaj(evren-n5 e)))  (image-width (nesne-imaj(evren-n3 e)))))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
 ( (<  (mesafe (nesne-yer (evren-n5 e)) (nesne-yer (evren-n4 e)))
        (+  (image-width (nesne-imaj(evren-n5 e)))  (image-width (nesne-imaj(evren-n4 e)))))
  ...
  (nesne (nesne-imaj
   ...
   (+ (evren-skor e) 20 )))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
( (< (v-x (nesne-yer (evren-n2 e))) (- 0 (/ (image-width (nesne-imaj (evren-n2 e))) 2)))
      (evren
   (evren-bg e)
   (evren-n1 e)
   (nesne (nesne-imaj
...
(evren
 welldone
 (nesne (nesne-imaj (evren-n1 e)) (v -50 -50) (v 0 0) (v 0 0))
 (nesne (nesne-imaj (evren-n2 e)) (v -50 -50) (v -3 0) (v -0.02 0))
 (nesne (nesne-imaj (evren-n3 e)) (v -50 -50) (v -3 0) (v -0.02 0))
 
 (nesne (nesne-imaj (evren-n4 e)) (v -50 -50) (v -3 0) (v -0.02 0))
 (nesne (nesne-imaj (evren-n4 e)) (v -50 -50)  (v 80 0) (v 0 0)) 
 (evren-skor e)))
...
(evren
 gameover
 (nesne (nesne-imaj (evren-n1 e)) (v -50 -50) (v 0 0) (v 0 0))
 (nesne (nesne-imaj (evren-n2 e)) (v -50 -50) (v 0 0) (v 0 0))
 (nesne (nesne-imaj (evren-n3 e)) (v -50 -50) (v 0 0) (v 02 0))
 
 (nesne (nesne-imaj (evren-n4 e)) (v -50 -50) (v 0 0) (v 0 0))
 (nesne (nesne-imaj (evren-n4 e)) (v -50 -50)  (v 80 0) (v 0 0)) 
 (evren-skor e)))
...
;;oyuncu hareket
;;oyuncu-guncelle nesne metin -> nesne
...
(define (oyuncu-guncelle n yon) 
  (nesne
   ...
   (cond
     ((string=? yon "up")
      (cond
        ((oyuncu-üst n) (v (v-x (nesne-yer n))(-(v-y (nesne-yer n)) oyuncu-adim)))
        (else (nesne-yer n))))
     ...
     ((string=? yon "down")
      (cond
        ((oyuncu-alt n)
         (v (v-x (nesne-yer n))(+ (v-y (nesne-yer n)) oyuncu-adim)))
        (else (nesne-yer n))))
     (else (nesne-yer n)))
   (nesne-hız n)
   (nesne-ivme n)))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;oyuncu yukarı aşşa gtmesin

(define (oyuncu-üst n)
  (<= (/(image-height (nesne-imaj n )) 2) (v-y (nesne-yer n))))
(define (oyuncu-alt n)
  (>= (- (image-height (evren-bg yaradılış)) (* (image-height (nesne-imaj n)) 1.2)) (v-y (nesne-yer n))))
...
(define (soldan-döndür n)
  (cond
    ( (< (v-x (nesne-yer n)) (- 0 (/ (image-width (nesne-imaj n)) 2)))
      (nesne (nesne-imaj n) (v (+ (image-width BACKGROUND) (/ (image-width (nesne-imaj n)) 2)) (random 50  700 )) (nesne-hız n) (nesne-ivme n )))
    (else n))) 
...
;(ÖRNEK (sağdan-döndür ((evren BACKGROUND
;         (nesne (scale 0.2 (bitmap "imaj/oyuncuson.png")) (v 30 600) (v 0 0) (v 0 0))
;         düşman1
;         düşman2
;         düşman3
;         (nesne
;                       (rectangle 50 5 "solid" "red")
;                       (v 1800 39)
;                       (v 3 0) (v 1 0))
;         0)))
;       
...
(define (sağdan-döndür e)
  
    (cond
   [ (> (v-x (nesne-yer (evren-n5 e))) (image-width BACKGROUND) )
   (nesne (nesne-imaj (evren-n5 e)) (nesne-yer (evren-n1 e )) (nesne-hız(evren-n5 e))(nesne-ivme (evren-n5 e)))]
   [else (evren-n5 e)]))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;GİZEM-GÜNCELLE NESNE METİN -> METİN  
  
(ÖRNEK (gizem-güncelle ateş " ")(nesne
                                 (nesne-imaj ateş)
                                 (v  (+ (v-x (nesne-yer ateş)) oyuncu-adim) (v-y (nesne-yer ateş)))
                                 (nesne-hız ateş) (nesne-ivme ateş)))


                                      
(define (gizem-güncelle n t) (cond
                               [(string=? t " " ) (nesne-fizik-güncelle n)]
                               [else n]))
...
(define (evren-tuş e t)
  ...
  (evren
   ...
   (evren-n3 e)
   (evren-n4 e)
   (oyuncu-guncelle(gizem-güncelle (evren-n5 e) t)t)
   (evren-skor e)))))
