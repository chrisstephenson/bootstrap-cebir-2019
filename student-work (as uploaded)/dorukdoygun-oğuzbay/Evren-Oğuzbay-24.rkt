...
(define ateş (nesne (rectangle 50 5 "solid" "red") (v 40 600) (v 0 0) (v 0 0)))
...
;;oyuncu hareket
;;oyuncu-guncelle nesne metin -> vektör
...
(define (oyuncu-alt n)
(>= (- (image-height (evren-bg yaradılış)) (* (image-height (nesne-imaj n)) 1.5)) (v-y (nesne-yer n))))
