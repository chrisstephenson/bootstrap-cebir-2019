...
(define düşman1 (nesne (scale 0.5 (bitmap "imaj/duşmanbüyükson.png")) (v 1300 (* (random 1 4) 150) ) (v -3 0) (v -0.02 0)))
...
(define ateş (nesne (rectangle 50 5 "solid" "red") (v 40 600)  (v 3 0) (v 1 0)))
