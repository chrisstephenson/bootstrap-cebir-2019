...
(define giriş-bg (bitmap "Teachpacks/teachpack-images/oyunsonu.png"))
(define bitiş-bg (bitmap "Teachpacks/teachpack-images/giriş-ekranı.png"))
...
;hız vektör
;ivme vektör
(STRUCT evren ( giriş sahne1 sahne2 bitiş sahne-sayı))
;sahne1 sahne
;sahne2 sahne
...
;SÖZLEŞME sahne-> sahne
;amaç sahnenin bir frame sonraki halini vermek
...
;                                    ....(evren-n1 e))
(define (sahne-güncelle e) (sahne (sahne-bg e)
                                  (nesne-fizik-güncelle (sahne-tehlike e))
                                  (nesne-fizik-güncelle (sahne-oyuncu e))
                                  (nesne-fizik-güncelle (sahne-hedef e))
                                  (nesne-fizik-güncelle (sahne-predo e))
                                  (sahne-zemin e)
                                  (sahne-skor e)))
  

;SÖZLEŞME sahne -> görüntü
;bir evren çizecek
...
;SÖZLEŞME evren-güncelle evren ->evren
;bir evren alıp hangi evren günceller
(define (evren-sahne-güncelle e) (cond
                             ((= (evren-sahne-sayı e) 1) (evren (evren-giriş e) (sahne-güncelle (evren-sahne1 e)) (evren-sahne2 e) (evren-bitiş e) 1))
                             ((= (evren-sahne-sayı e) 2) (evren (evren-giriş e)  (evren-sahne1 e) (sahne-güncelle (evren-sahne2 e)) (evren-bitiş e) 2))
                             ))

(define (evren-çiz e) (cond
                        ((= (evren-sahne-sayı e) 0) (sahne-çiz sahne-0))
                        ((= (evren-sahne-sayı e) 1) (sahne-çiz sahne-1))
                        ((= (evren-sahne-sayı e) 2) (sahne-çiz sahne-2))
                        ((= (evren-sahne-sayı e) 1) (sahne-çiz sahne-3))))
; SÖZLEŞME evren -> evren
;bir evren alıp belli koşullarda sahne sayısını değiştirdiği bir evren oluşturur

(define (evren-sahne-geçiş e)  (cond
                                 ((>= (sahne-skor (evren-sahne1 e)) 500) (evren (evren-giriş e)
                                                                                (evren-sahne1 e)
                                                                                (evren-sahne2 e)
                                                                                (evren-bitiş e)
                                                                                2))
...
;SÖZLEŞME evren -> sahne
(define (evren-güncelle e) (evren-sahne-güncelle  (evren-sahne-geçiş e)))
...
(define yaradılış  (evren giriş-bg sahne-1 sahne-2 bitiş-bg 1 ))
