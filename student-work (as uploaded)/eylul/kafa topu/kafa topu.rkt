...
(ÖRNEK ( evren-çiz ( evren BACKGROUND ( nesne ( circle 10 "solid" "red" )( v 50 50 )
                                               ( v 0 0 )
                                               ( v 0 0 ) ) 
                            ( nesne ( square 20 "solid" "green" ) ( v 100 150 )
                                    ( v 0 0 )
                                    ( v 0 0 ) ) 
                            ( nesne ( triangle 30 "solid" "yellow" ) ( v 200 300 )
                                    ( v 0 0 )
                                    ( v 0 0 ) ) ) )
        ( nesne-çiz ( nesne ( circle 10 "solid" "red" ) ( v 50 50 )
                            ( v 0 0 )
                            ( v 0 0 ) ) 
        ( nesne-çiz ( nesne ( square 20 "solid" "green" ) ( v 100 150 )
                                    ( v 0 0 )
                                    ( v 0 0 ) )    
        ( nesne-çiz ( nesne ( triangle 30 "solid" "yellow" ) ( v 200 300 )
                            ( v 0 0 )
                            ( v 0 0 ) ) BACKGROUND ) ) ) )   
...
( ÖRNEK ( evren-güncelle yaradılış ) ( evren BACKGROUND ( nesne ( circle 20 "solid" "red" ) ( v 60 567 )
                                                                                            ( v 30 -32 )
                                                                                            ( v 0 1 ) )
                                                        ( nesne ( square 40 "solid" "green" ) ( v 950 275 )
                                                                                              ( v -20 -24 )
                                                                                              ( v 0 1 ) )
                                                        ( nesne ( triangle 35 "solid" "yellow" ) ( v 355 522 )
                                                                                                 ( v 5 -27 )
                                                                                                 ( v 0 1 ) ) ) )
...
( define yaradılış
   ( evren BACKGROUND
           ( nesne ( circle 20 "solid" "red" ) ( v 30 600 )
                                               ( v 30 -33 )
                                               ( v 0 1 ) )
           ( nesne ( square 40 "solid" "green" ) ( v 970 300 )
                                                 ( v -20 -25 )
                                                 ( v 0 1 ) ) 
           ( nesne ( triangle 35 "solid" "yellow" ) ( v 350 550 )
                                                    ( v 5 -28 )
                                                    ( v 0 1 ) ) ) ) 
