...
(define oyuncu1 ( scale 0.2 ( bitmap "imaj/peter.png")) )

(define oyuncu2 ( scale 0.2  ( bitmap "imaj/dumbo.png")) )

(define top ( scale 0.2 ( bitmap "imaj/top.jpg")) )
...
( define ( evren-güncelle e ) ( evren ( evren-bg e )  ( evren-n1 e ) 
                                      ( nesne-fizik-güncelle ( evren-n2 e ))
                                      ( alt-güvende-mi ( + ( background-height ( /( image-height (nesne-imaj ( evren-n1 e ) ) ) 2 )  )n ) )
                                      (üst-güvende-mi ( - ( background-height ( / ( image-height ( nesne-imaj ( evren-n2 e) ) ) 2 ) )n ) )
                                      ( nesne-fizik-güncelle ( evren-n3 e ) ) 0) 0 0 )
...
(define (evren-tuş e t)
  ( evren ( evren-bg e )
          ( oyuncu1-güncelle (evren-n1 e) t )
          ( oyuncu2-güncelle ( evren-n2 e ) t )
          ( evren-n3 e )
          ( evren-skor1 e )
          ( evren-skor2 e ) ) ) 
...
( define ( nesne-sek n bg gol-y-üst gol-y-alt ) ( cond ( ( gol-y? ( v-y ( nesne-yer n ) ) gol-y-üst gol-y-alt ) n ) ( else ( nesne-sek-gol-yoksa n bg ) ) ) )

; oyuncu1-güncelle nesne string -> nesne

( define oyuncu-adım 5 ) 

( define ( oyuncu1-güncelle bg n t ) 
   ( alt-güvende-mi ( + ( background-height ( /( image-height (nesne-imaj n ) ) 2 )  )n ) (üst-güvende-mi ( - ( background-height ( / ( image-height ( nesne-imaj n ) ) 2 ) )n )  ( ( nesne ( nesne-imaj n )
                                                                                                                                                                                            ( cond
...
( define ( oyuncu2-güncelle bg n t )
   ( alt-güvende-mi ( + ( background-height ( / ( image-height ( nesne-imaj n ) ) 2 ) ) n ) (üst-güvende-mi ( - ( background-height ( / ( image-height ( nesne-imaj n ) )  2 ) )n ) ( ( nesne ( nesne-imaj n )
                                                                                                                                                                                           ( cond
