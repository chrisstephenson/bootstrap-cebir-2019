...
( define ( sahne-2-güncelle e )
   ( sahne-2 bg-iki 
  (elma-döndür ( nesne-fizik-güncelle (sahne-2-elma e )))
...
( define ( sahne-2-tuş-s s t)
   (cond
     (( string=? t "left")
                 (sahne-2 (sahne-2-bg-iki s)(sahne-2-elma s)(hareket-et ( sahne-2-sepet s )(v -5 0))(sahne-2-skor-e s)))
       (( string=? t "right")
                 (sahne-2 (sahne-2-bg-iki s)(sahne-2-elma s)(hareket-et ( sahne-2-sepet s )(v 5 0))(sahne-2-skor-e s)))
     (else s)))
