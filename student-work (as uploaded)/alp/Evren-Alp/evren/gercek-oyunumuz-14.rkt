...
(define (evren-tuş e t)
  (evren (evren-bg e) (evren-n1 e) (evren-n2 e)(oyuncu-1 (evren-n3 e) t)
...
(nesne (nesne-imaj n)
       (cond
        ((string=? t "up") (v (v-x (nesne-yer n))(- (v-y (nesne-yer n)) 10)))
        ((string=? t "right")(v (+ (v-x (nesne-yer n)) 10) (v-y (nesne-yer n))))
        (else (nesne-yer n))) (nesne-hız n)(nesne-ivme n)))
