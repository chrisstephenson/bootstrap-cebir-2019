...
;; nesne-anim nesne--> anim
;; nesne yi animasyon a çevirecek
( define ( nesne-anim n )
   ( nesne (anim-güncelle (imaj->görüntü (nesne-imaj n))) (nesne-yer n) ( nesne-hız n) ( nesne-ivme n ))) 
...
(ÖRNEK ( evren-tuş yaradılış "a" )
       ( evren ( evren-background yaradılış )
               ...
               (nesne-fizik-güncelle (evren-tehlike1 yaradılış))
...
(define ( evren-tuş e t )
  ( evren ( evren-background e )
          ( evren-oyuncu e )
          [cond
            [(string=? t "a") (evren-tehlike1 e)] 
            [else (hayalet-sağ (evren-tehlike1 e ))]]
          ( evren-soru e)
          ( evren-cevapa1 e)
          ( evren-cevapb1 e)
          ( evren-cevapc1 e)
