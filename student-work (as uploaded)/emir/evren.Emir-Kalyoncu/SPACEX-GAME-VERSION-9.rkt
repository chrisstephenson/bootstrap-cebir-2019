...
(define (evren-güncelle e)
  (evren (evren-arkaplanı e)
         (evren-dünya e)
  (if (< (v-mag (mesafe-ölç (evren-t1 e) (evren-oyuncu e))) 30 ) (nesne (scale 0.04(bitmap "imaj/içiboşkalp.png")) (nesne-yer (evren-oyuncu e)) (v 0 0) (v 0 0)) (evren-oyuncu e))
   (nesne-tekrarla-t1 e (evren-t1 e))                           
  (nesne-tekrarla-t2 e (evren-t2 e))
  (nesne-tekrarla-amaç e (evren-amaç e)) BENZİN-TİMER (zaman-güncelle GENEL-ZAMAN)
...
(define (oyuncuDur e t)
  (if (çarpıştı-mı? (evren-t1 e) (evren-oyuncu e)) (nesne (circle 10 "solid" "red") (nesne-yer (evren-oyuncu e)) (v 0 0) (v 0 0)) (oyuncu-güncelle (evren-oyuncu e) t)))
...
(define (evren-tuş e t)
  ...
  (evren-t1 e)                           
  (evren-t2 e)
  (evren-amaç e) BENZİN-TİMER GENEL-ZAMAN
  (if (> (evren-canSayısı e) 0) CAN1 (scale 0.05 (bitmap "imaj/içiboşkalp.png")))
  (if (> (evren-canSayısı e) 1) CAN2 (scale 0.05 (bitmap "imaj/içiboşkalp.png")))
  (evren-canSayısı e)))
