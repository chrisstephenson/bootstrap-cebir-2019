...
(define yaradılış
  (evren BACKGROUND
         (nesne (circle 42 "solid" "red") (v (/ (image-width BACKGROUND) 2) 50) (v 0 0) (v 0.07 0.1))
         (nesne (square 30 "solid" "red") (v 920 68) (v 0 0) (v 0 1))
         (nesne (square 70 "solid" "red") (v 100 12) (v 0 0) (v 0 1))))
