  ...
  (cond
    ((<= (evren-canSayısı e) 0)
     (evren 
                                ...
                                (evren-dünya e)
                                (evren-oyuncu e)
                                (nesne (nesne-imaj (evren-t1 e)) (v 1250 65) (v 0 0) (v 0 0))                           
                                (nesne (nesne-imaj (evren-t2 e)) (v 1750 65) (v 0 0) (v 0 0))
                                (nesne (nesne-imaj (evren-t2 e)) (v 1000 650) (v 0 0) (v 0 0))
                                0
                                0
...
(define (oyuncuDur e t)
  (if (or (çarpıştı-mı? (evren-t1 e) (evren-oyuncu e))
          ...
          (< (evren-canSayısı e) 0))
      (nesne (scale 0.04 (bitmap "imaj/içiboşkalp.png"))
