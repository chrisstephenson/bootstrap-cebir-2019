...
(define (evren-güncelle e)
  (evren (evren-arkaplanı e)
         (evren-dünya e)
  (evren-oyuncu e)
  (nesne-tekrarla e (evren-t1 e))                           
  (nesne-tekrarla e (evren-t2 e))
  (nesne-tekrarla e (evren-amaç e)) BENZİN-TİMER GENEL-ZAMAN CAN1 CAN2 CANSAYISI))
