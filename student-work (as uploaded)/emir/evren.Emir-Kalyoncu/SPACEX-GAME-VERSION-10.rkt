...
;can1 --> ekranın sol üstündeki ilk görüntüyü verir
; can2 --> ekranın sol üstündeki ikinci görüntüyü verir
; canSayısı --> oyuncunun kaç tane canı olduğunu verir
...
(define (evren-güncelle e)
  (evren (evren-arkaplanı e)
         (evren-dünya e)
         (if (and(or (çarpıştı-mı? (evren-t1 e) (evren-oyuncu e)) (çarpıştı-mı? (evren-t2 e) (evren-oyuncu e)) ) (<= (evren-canSayısı e) 0))
             (nesne (scale 0.04 (bitmap "imaj/içiboşkalp.png")) (nesne-yer (evren-oyuncu e)) (v 0 0) (v 0 0)) (evren-oyuncu e))
