...
(define (evren-güncelle e)
  (cond
    ...
    (else (evren
           ...
           (evren-dünya e)
           (evren-oyuncu e)
           (if (çarpıştı-mı? (evren-t1 e) (evren-oyuncu e)) (nesne-terse-döndür (evren-t1 e)) (if (> (evren-genel-zaman e) 100) (level2-nesne-tekrarla-t1 e (evren-t1 e)) (nesne-tekrarla-t1 e (evren-t1 e))))                           
...
(define(level2-nesne-tekrarla-t1 e n)
  (if (> (v-y (nesne-yer n)) 683)  (nesne (scale (random 1 4) TEHLİKE1) (v (random 990 1100) (random 650 683)) (v (random -24 -19) (random -24 -22)) (v 0 1)) (nesne-fizik-güncelle  (evren-t1 e)))) 
