...
;;
(STRUCT evren (arkaplanı n1 n2 n3 n4 n5 n6))
...
(ÖRNEK (evren-çiz (evren BACKGROUND
      ...
      (place-text/v (v 100 100) "hi cnm" 50 "blue" (nesne (triangle 60 "solid" "green")(v 100 300)(v 0 0)(v 0 0))))
...
(define (evren-çiz e)
(place-text/v (v 100 100) "hi cnm" 50 "blue" (nesne-çiz (evren-n1 e)
...
(define yaradılış
  ...
  (nesne (triangle 35 "solid" "yellow")(v 350 550)(v 5 -16)(v 0 1))
  (nesne (circle 40 "solid" "blue")(v 100 100)(v 0 0)(v 0 0))
  (nesne (square 50 "solid" "dark blue")(v 200 250)(v 0 0)(v 0 0))
