...
(define pasta-örneği
  (pasta "pink"  3 "Mutlu Yıllar" "white" 200 20))
...
;verilen ismi pastanın mesajına eklemek

(define (isim-ekle pasta-örneği isim)
  (pasta
   (pasta-renk pasta-örneği)
   (pasta-kat pasta-örneği)
   (string-append (pasta-mesaj pasta-örneği) isim)
   (pasta-mesaj-rengi pasta-örneği)
   (pasta-yarı-çap pasta-örneği)                                                    
   (pasta-kat-kalınlık pasta-örneği)))       

(ÖRNEK (isim-ekle (pasta "red" "white" 3 "İyiki Doğdun " 2 4) "Aybüke" )
       (pasta "red" "white" 3 "İyiki Doğdun Aybüke" 2 4))
