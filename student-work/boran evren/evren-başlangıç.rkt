...
(define (evren-çarpışma e)
  (cond
    [(< (mesafe (evren-n2 e) (evren-n3 e)) (/ image-width-n2 2)) 
...
(ÖRNEK (evren-tuş yaradılış "left")
       (evren arkaplan
              (nesne (rotate 5 oyuncu) (nesne-yer (evren-n1 yaradılış)) (nesne-hız (evren-n1 yaradılış)) (nesne-ivme (evren-n1 yaradılış)))
...
(define (evren-tuş e t)
  (evren (evren-bg e)
         (nesne (cond
                  [(string=? t "left") (rotate 5 (nesne-imaj (evren-n1 e)))]
                  [(string=? t "right") (rotate -5 (nesne-imaj (evren-n1 e)))]
                  [else (nesne-imaj (evren-n1 e))])
                  (nesne-yer (evren-n1 e)) (nesne-hız (evren-n1 e)) (nesne-ivme (evren-n1 e)))
         (evren-n2 e)
         (evren-n3 e)))
