...
( define TEHLİKE-imaj( scale 0.60(bitmap "imaj/berilhayalet.PNG")))
( define SORU-imaj   ( bitmap "imaj/bubbletrue.PNG"))
( define TEHLİKE-2   ( scale 0.75( bitmap "imaj/bsahrahayalet.PNG")))
...
;;
(STRUCT evren (background oyuncu tehlike1 soru cevapa1 cevapb1 cevapc1 doğru yanlış soru-sayısı ) )
(ÖRNEK
