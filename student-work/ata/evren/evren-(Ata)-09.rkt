...
;SÖZLEŞME evren-güncelle sayı->boolean
;bir sayı alıp hangi sahneyi güncelleyeceğini bulur
(define (evren-güncelle e) (cond
                             ((= (evren-sahne-sayısı e) 1) (sahne-güncelle sahne-1))
                             ((= (evren-sahne-sayısı e) 2) (sahne-güncelle sahne-2) )
                             ))

(define (evren-çiz ) (cond
                        ((= (evren-sahne-sayısı e) 1) (sahne-çiz sahne-1))
                        ((= (evren-sahne-sayısı e) 2) (sahne-çiz sahne-2))))
