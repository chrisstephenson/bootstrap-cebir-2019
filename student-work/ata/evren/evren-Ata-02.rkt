...
;bg -> background n1 nesne n2 nesne n3 nesne
...
(define hız-dinazor (v 50 50))
(define ivme-dinazor (v 5 5))
...
(define hız-caveman (v 50 50))
(define ivme-caveman (v 5 5))
...
(define hız-hedef (v 50 50))
(define ivme-hedef (v 5 5))
