...
(define hız-hedef (v 0 5))
(define ivme-hedef (v 0 0.1))
...
(define (nesne-aşağıdan-döndür bg n sayı1 sayı2) (cond
                                   ((> (v-y (nesne-yer n)) (image-height bg) ) (nesne (nesne-imaj n)
...
(define (evren-tuş e t) (cond
                          ((string=? t "up") (evren (evren-bg e)
                                                    ...
                                                    (evren-zemin e)
                                                    (evren-skor e)))
                          ((string=? t "down") (evren (evren-bg e)
                                                      (evren-tehlike e)
                                                      (nesne (bitmap "Teachpacks/teachpack-images/caveman/cavemanstanding/cavemanstanding_1.png")
                                                             (v+v (nesne-yer (evren-oyuncu e)) (v 0 5))
                                                             (nesne-hız (evren-oyuncu e))
                                                      ...
                                                      (evren-zemin e)
                                                      (evren-skor e)))
                          ((string=? t "right") (evren (evren-bg e)
                                                       (evren-tehlike e)
                                                       (nesne (bitmap "Teachpacks/teachpack-images/caveman/cavemanstanding/cavemanstanding_1.png")
                                                              (v+v (nesne-yer (evren-oyuncu e)) (v 5 0))
                                                              (nesne-hız (evren-oyuncu e))
                                                              (nesne-ivme (evren-oyuncu e)) )
                                                       (evren-hedef e)
                                                       (evren-predo e)
                                                       (evren-zemin e)
                                                       (evren-skor e)))
                          ((string=? t "left") (evren (evren-bg e)
                                                      (evren-tehlike e)
                                                      (nesne (bitmap "Teachpacks/teachpack-images/caveman/cavemanstanding/cavemanstanding_1.png")
                                                             (v+v (nesne-yer (evren-oyuncu e)) (v -5 0))
                                                             (nesne-hız (evren-oyuncu e))
