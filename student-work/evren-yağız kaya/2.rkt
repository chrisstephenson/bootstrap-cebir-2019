...
(define (evren-güncelle e)
  (cond ((or (< (uzaklık (nesne-yer (evren-n1 e)) (nesne-yer (evren-n2 e))) 75)
             (< (uzaklık (nesne-yer (evren-n1 e)) (nesne-yer (evren-n3 e))) 75)
             (< (uzaklık (nesne-yer (evren-n1 e)) (nesne-yer (evren-n4 e))) 75)
             (< (uzaklık (nesne-yer (evren-n1 e)) (nesne-yer (evren-n5 e))) 75))
         (evren (bitmap "imaj/göz.png")
