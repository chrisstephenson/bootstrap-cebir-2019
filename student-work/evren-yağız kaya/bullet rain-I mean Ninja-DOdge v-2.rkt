...
(define (evren-güncelle e)
  (cond ((or (< (uzaklık (nesne-yer (evren-n1 e)) (nesne-yer (evren-n2 e))) 45)
             (< (uzaklık (nesne-yer (evren-n1 e)) (nesne-yer (evren-n3 e))) 45)
             (< (uzaklık (nesne-yer (evren-n1 e)) (nesne-yer (evren-n4 e))) 45)
             (< (uzaklık (nesne-yer (evren-n1 e)) (nesne-yer (evren-n5 e))) 45))
         (evren (bitmap "imaj/die-insect.png")
                (nesne (nesne-imaj (evren-n1 e)) (v 910 910)(v 0 0) (v 0 0))
                (nesne (nesne-imaj (evren-n2 e)) (v 910 910)(v 0 0) (v 0 0))
                (nesne (nesne-imaj (evren-n3 e)) (v 910 910)(v 0 0) (v 0 0))
                (nesne (nesne-imaj (evren-n4 e)) (v 910 910)(v 0 0) (v 0 0))
                (nesne (nesne-imaj (evren-n5 e)) (v 910 910)(v 0 0) (v 0 0))
                (evren-fare-v e)))
        (else
...
(define yaradılış (evren BACKGROUND
                 ...
                 (nesne (scale 0.68 (bitmap "imaj/monster.png")) (v  (random 1 640) 10) (v 0 18) (v 0 0))
                 (nesne (scale 0.68 (bitmap "imaj/monster.png")) (v  (random 1 640) 10) (v 0 16) (v 0 0))
                 (nesne (scale 0.68 (bitmap "imaj/monster.png")) (v  (random 1 640) 10) (v 0 14) (v 0 0))
                 (nesne (scale 0.68 (bitmap "imaj/monster.png")) (v  (random 1 640) 10) (v 0 13) (v 0 0))
                 (v 0 0)))
