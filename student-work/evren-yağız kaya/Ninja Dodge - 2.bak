...
;;
(STRUCT evren (arkaplanı n1 n2 n3 n4 n5 b1 b2 fare-v))

(define  (evren-çiz e)

               (nesne-çiz (evren-b1 e)
               (nesne-çiz (evren-b2 e)
               (nesne-çiz (evren-n1 e)
               (nesne-çiz (evren-n2 e)
               (nesne-çiz (evren-n3 e)
               (nesne-çiz (evren-n4 e)
               (nesne-çiz (evren-n5 e)             
               (place-image/v (circle 25 "solid" "black") (evren-fare-v e)
                          (evren-arkaplanı e))))))))))
...
(define (evren-güncelle e)
  (evren (evren-arkaplanı e)
         ...
         (nesne-fizik-güncelle (evren-b1 e))
         (nesne-fizik-güncelle (evren-b2 e))
         (evren-fare-v e)))
...
(define (v-ünit v) (v* (max 0.000000 (/ (v-mag v) 1)) v))
...
(define TEHLİKE-1 (nesne (triangle 100 "solid" "red") (v 254 -300) (v -20 -25) (v 0 1)))
(define TEHLİKE-2 (nesne (triangle 100 "solid" "red") (v 40 -550) (v 5 -18) (v 0 1)))
(define TEHLİKE-3 (nesne (triangle 100 "solid" "red") (v 0 240) (v 5 20) (v 0 1)))
(define TEHLİKE-4 (nesne (triangle 100 "solid" "red") (v 320 240) (v 5 20) (v 0 1)))
...
(define yaradılış (evren BACKGROUND
                 ...
                 (nesne (triangle 50 "solid" "red") (v  (random 1 640) 10) (v 0 0) (v 0 2.5))
                 (nesne (triangle 50 "solid" "red") (v  (random 1 640) 10) (v 0 0) (v 0 2.5))
                 (nesne (triangle 50 "solid" "red") (v  (random 1 640) 10) (v 0 0) (v 0 2.5))
                 (nesne (circle 25 "solid" "lightgreen") (v  (random 1 640) 10) (v 0 0) (v 0 2.5))
                 (nesne (scale 0.4 (bitmap "imaj/göz-bebeği.png")) (v 320 240) (v 0 0) (v 0 0))
                 (nesne (scale 0.4 (bitmap "imaj/göz-bebeği2.png")) (v 320 240) (v 0 0) (v 0 0))
                 (v 0 0)))
...
(ÖRNEK (evren-çiz (evren BACKGROUND
               (nesne (circle 10 "solid" "red") (v 50 50) (v 0 0) (v 0 -1))
               (nesne (square 10 "solid" "green") (v 100 150) (v 0 0) (v 0 -1))
               (nesne (triangle 10 "solid" "light yellow") (v 200 300) (v 0 0) (v 0 -1))))
