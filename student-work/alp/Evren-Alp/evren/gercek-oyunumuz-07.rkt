...
;(ÖRNEK (alt-güvenli-mi 0)#false)
;(ÖRNEK (alt-güvenli-mi 50)#true)
;(define ekran-yükseklik (image-height ARKAPLAN))
;(define oyuncu-yükseklik (image-height OYUNCU))
;(define oyuncu-genişlik (image-width OYUNCU))  
;(define (üst-güvenli-mi y)(<= (+ y (/ oyuncu-yükseklik 2))ekran-yükseklik))
;(define (alt-güvenli-mi y) (>= (- y (/ oyuncu-yükseklik 2)) 0))
;(ÖRNEK(oyuncu-güncelle 320 "up")  330)
;(ÖRNEK(oyuncu-güncelle 100 "down")  90)
;(ÖRNEK(oyuncu-güncelle 80 "left")  80)
;(ÖRNEK(oyuncu-güncelle 60 "right") 60)
;(define oyuncu-adımı 10) 
;(define(oyuncu-güncelle x yön)
;(cond  ((and (string=? yön "up")(üst-güvenli-mi x)) (+ x oyuncu-adımı))
;((and (string=? yön "down")(alt-güvenli-mi x)) (- x oyuncu-adımı))
;(else x)))


;------------------------------------------------------------------------------------------------------
;(Sözleşme alt güvenli-mi ve üst güvenli-mi yerine oyuncu-1-yoruldu-mu? ve oyuncu-2-yoruldu-mu? fonksiyonları olucak
;Oyuncu adımı yerine oyuncu-hareketi-oldu-mu? olucak 
