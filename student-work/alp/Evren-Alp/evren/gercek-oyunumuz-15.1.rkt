...
;(define (oyuncu-1-çarpıştı-mı? n) (cond (= (- (oyuncu-1-konum n2) (v 0 0)(+ (score-1 1))))
;(else nesne-yer-n))


;(define (oyuncu-2-çarpıştı-mı? n) (cond (= (- (oyuncu-3-konum n2) 0)(+ (score-2 1))))
;(else nesne-yer-n))
...
;(nesne-çiz (scale y (bitmap "x şey".png/jpg)))(v a b) (v c d) (v e f) (else ))
