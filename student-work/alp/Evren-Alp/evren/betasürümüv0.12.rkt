...
(ÖRNEK (evren-çiz (evren BACKGROUN
                         ...
                         (nesne (scale 0.36 (bitmap "imaj/para.png")) (v 320 240) (v 0 0) ( v 0 0 ))
                         (nesne (scale 0.36 (bitmap "imaj/para.png")) (v 320 240) (v 0 0) (v 0 0))1 1))         
                  (place-text/v (v 320 55) (string-append (string-append "Score 1 : " (number->string 1)) 
                                                         (string-append " Score 2 : " (number->string 1))) 40 "red"
                             ...
                             (nesne-çiz (nesne (scale 0.36 (bitmap "imaj/para.png")) (v 340 240) (v 0 0) ( v 0 0 ))
                                        ...
                                        (nesne-çiz (nesne (scale 0.36 (bitmap "imaj/para.png")) (v 340 240) (v 0 0)(v 0 0)) 
                                        (nesne-çiz (nesne (scale 0.36 (bitmap "imaj/arkaplan.png")) (v 340 240) (v 0 0)(v 0 0)) 
                                        BACKGROUND)))))))
(define (evren-çiz e)
...
(define yaradılış (evren BACKGROUND
                         ...
                         (nesne (scale 0.36 (bitmap "imaj/para.png")) (v 320 240) (v 0 0) (v 0 0))
                         (nesne (scale 0.36 (bitmap "imaj/para.png")) (v 320 240) (v 0 0) (v 0 0)) 10 10))
(ÖRNEK
  ...
  (nesne-fizik-güncelle (nesne(scale 0.36 (bitmap "imaj/para.png"))(v 320 240)(v 0 0)(v 0 0)))
  (nesne-fizik-güncelle (nesne(scale 0.36 (bitmap "imaj/para.png"))(v 320 240)(v 0 0)(v 0 0))) 10 10))
(define (evren-güncelle e)
 (arkaplan-gözükçek-mi? (evren (evren-bg e)
...
(define (arkaplan-gözükçek-mi? e)
  (cond
    ((= (evren-score-1 e) 1000)
     (evren (bitmap "imaj/1.oyuncukzandıekranı.png")
            (nesne (nesne-imaj (evren-n1 e)) (v 0 5000) (v 0 0) (v 0 0))
            (nesne (nesne-imaj (evren-n2 e)) (v 0 6500) (v 0 0) (v 0 0))
            (nesne (nesne-imaj (evren-n3 e)) (v 0 5000) (v 0 0) (v 0 0))
            (nesne (nesne-imaj (evren-n4 e)) (v 0 6500) (v 0 0) (v 0 0))
            (nesne (nesne-imaj (evren-n5 e)) (v 0 6500) (v 0 0) (v 0 0))
            (evren-score-1 e) (evren-score-2 e)))
    ((= (evren-score-2 e) 1000)
     (evren (bitmap "imaj/2.oyuncukzandıekranı.png")
            (nesne (nesne-imaj (evren-n1 e)) (v 0 5000) (v 0 0) (v 0 0))
            (nesne (nesne-imaj (evren-n2 e)) (v 0 6500) (v 0 0) (v 0 0))
            (nesne (nesne-imaj (evren-n3 e)) (v 0 5000) (v 0 0) (v 0 0))
            (nesne (nesne-imaj (evren-n4 e)) (v 0 6500) (v 0 0) (v 0 0))
...
;(ÖRNEK (SES 0 "ses/infernal-catharis.mp3") 0)
...
;; arkaplan-gözükç-mi evren --> evren
