...
; (ÖRNEK (OYUNCU 120 160)#true
; (ÖRNEK (OYUNCU 500 600)#false
; (define (nesne (OYUNCU ("bitmap/kosedeki.png"))))I
; (put-image OYUNCU y x)
...
(define yaradılış (evren BACKGROUND
                         ...
                         (nesne (bitmap "imaj/kosedeki.png")
...
;(define OYUNCU (bitmap "imaj/elat.png))
