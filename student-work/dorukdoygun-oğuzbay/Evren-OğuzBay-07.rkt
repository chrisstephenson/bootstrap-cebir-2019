...
(define oyuncu (scale 0.2 (bitmap "imaj/oyuncuson.png")))
(define düşman1 (scale 0.5 (bitmap "imaj/duşmanbüyükson.png")))
(define düşman2 (scale 0.05(bitmap "imaj/düşmanküçükson.png")))
...
(ÖRNEK
 (evren-çiz (evren BACKGROUND
                   (nesne  oyuncu
                                 (v 50 50) (v 0 0) (v 0 0))
                   (nesne  düşman1
                                 (v 100 150) (v 0 0) (v 0 0))
                   (nesne  düşman2
                                 (v 200 500) (v 0 0) (v 0 0))))
                   (nesne-çiz (nesne  oyuncu
                                 (v 50 50) (v 0 0) (v 0 0))
                   (nesne-çiz (nesne   düşman1
                                 (v 100 150) (v 0 0) (v 0 0))
                   (nesne-çiz (nesne   düşman2
                                 (v 200 500) (v 0 0) (v 0 0))BACKGROUND))))

(define (evren-çiz e) (nesne-çiz (evren-n1 e) (nesne-çiz (evren-n2 e) (nesne-çiz (evren-n3 e)(evren-bg e)))))

 (define yaradılış
   (evren BACKGROUND
          (nesne oyuncu (v 30 600) (v 30 -33) (v 0 1))
          (nesne düşman1 (v 970 300) (v -20 -75) (v 0 1))
          (nesne düşman2 (v 350 550) (v 5 -26) (v 0 1))))
...
(ÖRNEK
 ...
 (evren BACKGROUND
        ...
        (nesne düşman1 (v 950 225) (v -20 -74) (v 0 1))
        (nesne düşman2 (v 355 524) (v 5 -25) (v 0 1))))
