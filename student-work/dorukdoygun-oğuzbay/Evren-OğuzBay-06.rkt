...
(ÖRNEK
 (evren-çiz (evren BACKGROUND
                   (nesne (circle 10 "solid" "red")
                                 (v 50 50) (v 0 0) (v 0 0))
                   (nesne (square 40 "solid" "green")
                                 (v 100 150) (v 0 0) (v 0 0))
                   (nesne (triangle 30 "solid" "yellow")
                                 (v 200 500) (v 0 0) (v 0 0))))
                   (nesne-çiz (nesne (circle 10 "solid" "red")
                                 (v 50 50) (v 0 0) (v 0 0))
                   (nesne-çiz(nesne (square 40 "solid" "green")
                                 (v 100 150) (v 0 0) (v 0 0))
                   (nesne-çiz(nesne (triangle 30 "solid" "yellow")
...
(define (evren-çiz e) (nesne-çiz (evren-n1 e) (nesne-çiz (evren-n2 e) (nesne-çiz (evren-n3 e)(evren-bg e)))))
 ...
 (define yaradılış
   (evren BACKGROUND
          ...
          (nesne (square 40 "solid" "green") (v 970 300) (v -20 -75) (v 0 1))
          (nesne (triangle 35 "solid" "yellow") (v 350 550) (v 5 -26) (v 0 1))))
...
(ÖRNEK
 ...
 (evren BACKGROUND
        ...
        (nesne (square 40 "solid" "green") (v 950 225) (v -20 -74) (v 0 1))
        (nesne (triangle 35 "solid" "yellow") (v 355 524) (v 5 -25) (v 0 1))))
