...
(define (sağdan-döndür n)
  (cond
   ( (> (v-x (nesne-yer n)) (- (image-width BACKGROUND) (/ (image-width (nesne-imaj n)) 2)))
      (nesne (nesne-imaj n) (v (+ (image-width BACKGROUND) (/ (image-width (nesne-imaj n)) 2)) (nesne-yer oyuncu )) (nesne-hız n) (nesne-ivme n )))
    (else n))) 
