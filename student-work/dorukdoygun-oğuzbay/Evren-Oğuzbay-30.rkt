...
(define düşman1 (nesne (scale 0.8 (bitmap "imaj/duşmanbüyükson.png")) (v 1300 (* (random 1 4) 150) ) (v -3 0) (v -0.1 0)))
(define düşman2 (nesne (scale 0.10 (bitmap "imaj/düşmanküçükson.png")) (v 1300 (* (random 1 4) 150 )) (v -3 0) (v -0.1 0)))
(define düşman3 (nesne (scale 0.05 (bitmap "imaj/düşmanküçükson2.png")) (v 1300 (* (random 1 4) 150 )) (v -3 0) (v -0.1 0)))
(define ateş (nesne (rectangle 50 5 "solid" "red") (v 40 600)  (v 80 0) (v 0 0)))
